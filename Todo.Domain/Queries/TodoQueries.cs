...
namespace Todo.Domain.Queries
{
    public static class TodoQueries
    {
        ...
        public static Expression<Func<TodoItem, bool>> GetByPeriod(string user, DateTime time, bool done)
        {
            return x => x.User.Equals(user)
                     && x.Done == done
